...
public class PacMan extends JPanel implements ActionListener, KeyListener {
    ...
    PacMan() {
        ...
        //how logn it takes to start timer, milliseconds gone between frames
    ...
    public void move(){
        ...
        while (foodIterator.hasNext()) {
            ...
            if (collison(pacman, food)) {
                foodIterator.remove(); // Sicher entfernen während der Iteration
                score += 10;
                if (foods.isEmpty()){
                    loadMap();
                    resetPosititons();
